...
import ar.edu.unlam.programacion3.oia.seleccion.NoSePuedeVivirAhi;

public class CorrerTodoElLote {

	private final static String IN_PATH = "Lote de Pruebas/Entradas/";
	private final static String OUT_PATH = "Lote de Pruebas/Salidas Generadas/";

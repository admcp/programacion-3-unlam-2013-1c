...
public class GrafoSimple {
	...
	public GrafoSimple(int cantidadNodos) {
		if (cantidadNodos < 0) {
	...
	public void quitarArco(int nodoOrigen, int nodoDestino) {
		...
		matrizDeAdyacencia[nodoDestino - 1][nodoOrigen - 1] = false;
	}
	...
	public static void main(String[] args) {
		...
		GrafoSimple grafo = new GrafoSimple(10);
		...
		if(STRESS) {
			...
			grafo = new GrafoSimple(cantidadNodos);
			for(int i = 0; i < cantidadNodos; i++) {
